<section class="hero" id="home" style="background-image: url('{{ asset('client/assets/images/hero-bg.jpg') }}');">
    <div class="container">
        ...
        <figure class="hero-banner">
            ...
            <img src="   {{ asset('client/assets/images/hero-banner-bg.png') }}"
                width="820" height="716" loading="lazy" alt="" class="w-100 hero-img-bg">
            <img src="    {{ asset('client/assets/images/hero-banner.png') }}" width="700"
    ...
    <ul class="promo-list has-scrollbar">
        ...
        <li class="promo-item">
            <div class="promo-card">
                ...
                <img src=" {{ asset('client/assets/images/promo-1.png') }}" loading="lazy"
        ...
        <li class="promo-item">
            <div class="promo-card">
                ...
                <img src=" {{ asset('client/assets/images/promo-2.png') }}" loading="lazy"
                    width="300" height="300" alt="" class="w-100 card-banner">
            </div>
        </li>
        ...
        <li class="promo-item">
            <div class="promo-card">
                ...
                <img src=" {{ asset('client/assets/images/promo-3.png') }}" loading="lazy"
                    width="300" height="300" alt="" class="w-100 card-banner">
            </div>
        </li>
        ...
        <li class="promo-item">
            <div class="promo-card">
                ...
                <img src=" {{ asset('client/assets/images/promo-4.png') }}" loading="lazy"
                    width="300" height="300" alt="" class="w-100 card-banner">
            </div>
        </li>
        <li class="promo-item">
            <div class="promo-card">
                ...
                <img src=" {{ asset('client/assets/images/promo-5.png') }}" loading="lazy"
                    width="300" height="300" alt="" class="w-100 card-banner">
            </div>
        </li>
...
<section class="section section-divider gray about">
    <div class="container">
        <div class="about-banner">
            ...
            <img src="{{ asset('client/assets/images/about-banner.png') }}" width="508"
                height="459" loading="lazy" alt="Burgers with Drinks" class="w-100 about-img">

            <img src="{{ asset('client/assets/images/sale-shape-red.png') }}" width="216" height="226"
